...
public class ExpandedContextDocument extends ContextDocument
{
	...
	public ExpandedContextDocument(Rectangle pageSize, float marginLeft, float marginRight, float marginTop, float marginBottom, Transaction transaction,
	...
	public ExpandedContextDocument(Rectangle pageSize, Transaction transaction, Context context, OutputStream outputStream)
	{
		super(pageSize, transaction, context, outputStream);
	}

	public ExpandedContextDocument(Transaction transaction, Context context, OutputStream outputStream)
	{
