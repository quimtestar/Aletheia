...
public class BerkeleyDBStatementLocalSet extends AbstractCloseableSet<StatementLocal> implements StatementLocalSet
{
	...
	public BerkeleyDBStatementLocalSet(BerkeleyDBPersistenceManager persistenceManager, BerkeleyDBTransaction transaction, ContextLocal contextLocal)
	{
		super();
		try
		{
			...
			this.index = persistenceManager.getEntityStore().statementLocalEntityContextSecondaryIndex().subIndex(new UUIDKey(contextLocal.getStatementUuid()));
		}
	...
	protected BerkeleyDBStatementLocalSet(BerkeleyDBPersistenceManager persistenceManager, BerkeleyDBTransaction transaction)
	{
