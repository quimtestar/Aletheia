...
DelegateAuthorizerByAuthorizerMap
{
	...
	private static SecondaryIndex<UUIDKey, PrimaryKeyData, BerkeleyDBDelegateAuthorizerEntity> makeIndex(BerkeleyDBPersistenceManager persistenceManager)
	{
		try
		{
			return persistenceManager.getEntityStore().delegateAuthorizerEntityAuthorizerSecondaryIndex();
		}
	...
	public BerkeleyDBDelegateAuthorizerByAuthorizerMap(BerkeleyDBPersistenceManager persistenceManager, BerkeleyDBTransaction transaction)
	{
		super(persistenceManager, transaction, makeIndex(persistenceManager), null, null);
	}

	@Override
	protected UUIDKey uuidToKey(UUID authorizerUuid)
	{
		return new UUIDKey(authorizerUuid);
	}
