		...
		implements PersonsMap
{
	private static PrimaryIndex<UUIDKey, BerkeleyDBPersonEntity> personEntityPrimaryIndex(BerkeleyDBPersistenceManager persistenceManager)
	{
		try
		{
			return persistenceManager.getEntityStore().personEntityPrimaryIndex();
		}
	...
	public BerkeleyDBPersonsMap(BerkeleyDBPersistenceManager persistenceManager, BerkeleyDBTransaction transaction)
	{
		super(persistenceManager, personEntityPrimaryIndex(persistenceManager), transaction);
	}
