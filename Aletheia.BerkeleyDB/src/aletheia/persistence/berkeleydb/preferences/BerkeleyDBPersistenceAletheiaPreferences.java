...
public class BerkeleyDBPersistenceAletheiaPreferences extends PersistenceAletheiaPreferences
{
	...
	public boolean configurationMatches(PersistenceManager persistenceManager)
	{
		...
		else
		{
			...
			if ((getDbFile() == null) || !getDbFile().equals(berkeleyDBPersistenceManager.getDbFile())
					|| (isReadOnly() != berkeleyDBPersistenceManager.isReadOnly()) || (getCachePercent() != berkeleyDBPersistenceManager.getCachePercent()))
				return false;
			return true;
		}
	}
