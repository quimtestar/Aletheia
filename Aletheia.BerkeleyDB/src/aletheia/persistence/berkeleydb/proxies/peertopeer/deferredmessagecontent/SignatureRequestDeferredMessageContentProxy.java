...
public class SignatureRequestDeferredMessageContentProxy extends CipheredDeferredMessageContentProxy<SignatureRequest, SignatureRequestDeferredMessageContent>
{
	...
	@Override
	public SignatureRequestDeferredMessageContent convertProxy() throws ProxyConversionException
	{
		return new SignatureRequestDeferredMessageContent(getVersion(), getCipher());
	}
