...
@Persistent(proxyFor = UnprojectedCastTypeTerm.class, version = 0)
public class UnprojectedCastTypeTermProxy extends CastTypeTermProxy<UnprojectedCastTypeTerm>
{
