...
public class EntityStoreUpgrade_016 extends EntityStoreUpgrade_017
{

	public EntityStoreUpgrade_016()
	{
	}
	...
	protected class UpgradeInstance extends EntityStoreUpgrade_017.UpgradeInstance
	{
		...
		{
			if (entityClass.equals(BerkeleyDBDelegateTreeNodeEntity.class))
			{
				if (oldRawObject.getType().getClassName().endsWith("BerkeleyDBDelegateTreeRootNodeEntity"))
				{
					try
					{
						BerkeleyDBDelegateTreeRootNodeEntity entity = (BerkeleyDBDelegateTreeRootNodeEntity) partialConvertRawObject(aletheiaModel,
								oldRawObject);
						entity.setSuccessorIndex(-1);
