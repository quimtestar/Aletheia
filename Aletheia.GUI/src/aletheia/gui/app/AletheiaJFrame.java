...
public class AletheiaJFrame extends JFrame
{
	...
	private class MyThrowableProcessor implements AletheiaEventQueue.ThrowableProcessor<AletheiaJFrame, PersistenceLockTimeoutException>
	{

		@Override
		public boolean processThrowable(AletheiaJFrame aletheiaJFrame, PersistenceLockTimeoutException e)
		{
	...
	private class ExtraJFrame extends JFrame
	{
	...
	public AletheiaJFrame(AletheiaGUI aletheiaGUI)
	{
		super();
