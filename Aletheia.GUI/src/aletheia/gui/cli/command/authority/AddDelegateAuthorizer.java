...
public class AddDelegateAuthorizer extends TransactionalCommand
{
	...
	public AddDelegateAuthorizer(CommandSource from, Transaction transaction, Person delegate, StatementAuthority statementAuthority, Namespace prefix)
	{
	...
	public static class Factory extends AbstractVoidCommandFactory<AddDelegateAuthorizer>
	{
		...
		@Override
		public AddDelegateAuthorizer parse(CommandSource from, Transaction transaction, Void extra, List<String> split) throws CommandParseException
		{
			try
			{
				...
				return new AddDelegateAuthorizer(from, transaction, delegate, statementAuthority, prefix);
			}
