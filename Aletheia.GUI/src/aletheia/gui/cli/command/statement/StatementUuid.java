...
public class StatementUuid extends TransactionalCommand
{
	...
	public StatementUuid(CliJPanel from, Transaction transaction, Statement statement)
	{
	...
	public static class Factory extends AbstractVoidCommandFactory<StatementUuid>
	{
		...
		@Override
		public StatementUuid parse(CliJPanel cliJPanel, Transaction transaction, Void extra, List<String> split) throws CommandParseException
		{
			...
			return new StatementUuid(cliJPanel, transaction, statement);
		}
