...
public class SubscribeNoneCommand extends SubscribeCommand
{

	public SubscribeNoneCommand(CommandSource from, Transaction transaction, Collection<? extends Statement> statements)
	{
	...
	protected RunTransactionalReturnData runTransactional() throws Exception
	{
		for (Statement st : getStatements())
		{
			...
			statementLocal.setSubscribeProof(getTransaction(), false);
