...
import aletheia.utilities.collections.CloseableList;

public interface HookList extends PersistenceManagerDataStructure, CloseableList<Hook>
{
	public Hook getNullOverflow(int i);

	public CloseableIterable<Hook> tail(long fromPriority);
}
