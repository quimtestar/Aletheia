...
{ "asterisk", "number" })
public class AN_asterisk_number_IntegerTokenSubProcessor extends IntegerTokenSubProcessor
{

	protected AN_asterisk_number_IntegerTokenSubProcessor(TokenProcessor processor)
	{
		super(processor);
	}
