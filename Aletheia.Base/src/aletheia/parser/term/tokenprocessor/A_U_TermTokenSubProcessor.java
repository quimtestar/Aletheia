...
{ "U" })
public class A_U_TermTokenSubProcessor extends TermTokenSubProcessor
{
	protected A_U_TermTokenSubProcessor(TokenProcessor processor)
	{
		super(processor);
	}
	...
	{
		return getProcessor().processTerm((NonTerminalToken) token.getChildren().get(0), context, transaction, tempParameterTable, parameterIdentifiers);
	}
