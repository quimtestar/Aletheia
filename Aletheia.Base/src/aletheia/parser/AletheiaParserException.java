...
public class AletheiaParserException extends Exception
{
	...
	public AletheiaParserException(String message, Location startLocation, Location stopLocation, String input)
	{
		super(message);
	...
	public AletheiaParserException(ParserLexerException e, String input)
	{
	...
	public AletheiaParserException(Exception e, Location startLocation, Location stopLocation, String input)
	{
		super(e.getMessage(), e);
		this.startLocation = startLocation;
		this.stopLocation = stopLocation;
