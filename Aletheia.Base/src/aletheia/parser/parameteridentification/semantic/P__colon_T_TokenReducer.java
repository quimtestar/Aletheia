...
{ "colon", "T" })
public class P__colon_T_TokenReducer extends ProductionTokenPayloadReducer<ParameterWithType>
{
	...
	{
		ParameterIdentification parameterType = NonTerminalToken.getPayloadFromTokenList(reducees, 1);
