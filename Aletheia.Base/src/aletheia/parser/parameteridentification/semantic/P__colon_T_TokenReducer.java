...
{ "colon", "T" })
public class P__colon_T_TokenReducer extends ProductionTokenPayloadReducer<ParameterWithDomain>
{
	...
	{
		ParameterIdentification domain = NonTerminalToken.getPayloadFromTokenList(reducees, 1);
		return new ParameterWithDomain(null, domain);
	}
