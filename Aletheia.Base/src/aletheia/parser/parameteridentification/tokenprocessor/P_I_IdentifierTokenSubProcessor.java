...
{ "I" })
public class P_I_IdentifierTokenSubProcessor extends IdentifierTokenSubProcessor
{
	...
	{
		return getProcessor().processIdentifier((NonTerminalToken) token.getChildren().get(0), input);
	}
