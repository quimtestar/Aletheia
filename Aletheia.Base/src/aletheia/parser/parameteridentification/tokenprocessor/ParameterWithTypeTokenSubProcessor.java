...
public abstract class ParameterWithTypeTokenSubProcessor extends TokenSubProcessor<ParameterWithType, Void>
{
	...
	@Override
	protected ParameterWithType subProcess(ParseTree token, Void parameter) throws TokenProcessorException
	{
		return subProcess(token);
	}

	protected abstract ParameterWithType subProcess(ParseTree token) throws TokenProcessorException;
