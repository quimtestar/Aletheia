...
public abstract class ParameterIdentificationTokenSubProcessor extends TokenSubProcessor<ParameterIdentification, Void>
{
	...
	@Override
	protected ParameterIdentification subProcess(ParseTree token, Void parameter) throws TokenProcessorException
	{
		return subProcess(token);
	}

	protected abstract ParameterIdentification subProcess(ParseTree token) throws TokenProcessorException;
