...
public class TokenProcessor
{
	...
	private final static List<Class<? extends TokenSubProcessor<?,?>>> subProcessorClasses=Arrays.asList(
			...
			B_B_bar_C_TermTokenSubProcessor.class,
			B_C_TermTokenSubProcessor.class,
			C_C_question_A_TermTokenSubProcessor.class,
			C_A_TermTokenSubProcessor.class,
	...
	public Term process(NonTerminalToken token, String input, Context context, Transaction transaction,
			Map<ParameterVariableTerm, Identifier> parameterIdentifiers) throws TermParserException
	{
	...
	protected Term processTerm(NonTerminalToken token, String input, Context context, Transaction transaction,
			Map<ParameterRef, ParameterVariableTerm> tempParameterTable) throws TermParserException
	{
		return processTerm(token, input, context, transaction, tempParameterTable, null);
	}

	protected ParameterRef processParameterRef(NonTerminalToken token, String input) throws TermParserException
	{
	...
	protected Identifier processIdentifier(NonTerminalToken token, String input) throws TermParserException
	{
	...
	protected Term processReference(NonTerminalToken token, String input, Context context, Transaction transaction) throws TermParserException
	{
	...
	protected UUID processUuid(TerminalToken token, String input) throws TermParserException
	{
		try
		{
	...
	protected Statement processStatement(NonTerminalToken token, String input, Context context, Transaction transaction) throws TermParserException
	{
	...
	protected boolean processBoolean(NonTerminalToken token, String input) throws TermParserException
	{
