...
{ "openpar", "T", "closepar" })
public class A_openpar_T_closepar_TermTokenSubProcessor extends TermTokenSubProcessor
{
	protected A_openpar_T_closepar_TermTokenSubProcessor(TokenProcessor processor)
	{
		super(processor);
	}
	...
	{
		return getProcessor().processTerm((NonTerminalToken) token.getChildren().get(1), input, context, transaction, tempParameterTable);
	}
