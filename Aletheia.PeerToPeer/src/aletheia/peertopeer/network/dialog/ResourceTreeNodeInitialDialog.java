...
public class ResourceTreeNodeInitialDialog extends ResourceTreeNodeDialog
{

	public ResourceTreeNodeInitialDialog(Phase phase)
	{
		super(phase);
	}
	...
	{
		dialogateResourceTreeNodeActionMapSend();
		dialogateResourceTreeNodeActionMapRecv();
	}
