...
public class RouterSetLoopDialogClient extends RouterSetLoopDialog
{
	private final Set<UUID> clearing;

	public RouterSetLoopDialogClient(Phase phase, Set<UUID> clearing)
	{
		super(phase);
	...
	{
		dialogateRouterSetSend(clearing);
	}
