...
public class ClosestNodeDialogMale extends ClosestNodeDialog
{

	public ClosestNodeDialogMale(Phase phase)
	{
		super(phase);
	}
	...
	{
		RedirectAddressMessage inetSocketAddressMessage = recvMessage(RedirectAddressMessage.class);
		setRedirectNodeAddress(inetSocketAddressMessage.getNodeAddress());
	}
