...
public abstract class ClosestNodeDialog extends NetworkNonPersistentDialog
{
	private NodeAddress redirectNodeAddress;

	public ClosestNodeDialog(Phase phase)
	{
		super(phase);
	...
	protected void setRedirectNodeAddress(NodeAddress redirectNodeAddress)
	{
