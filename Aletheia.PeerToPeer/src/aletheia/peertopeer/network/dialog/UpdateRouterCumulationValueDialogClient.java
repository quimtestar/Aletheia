...
public class UpdateRouterCumulationValueDialogClient extends UpdateRouterCumulationValueDialog
{
	private final int index;
	private final Cumulation.Value<?> cumulationValue;

	public UpdateRouterCumulationValueDialogClient(Phase phase, int index, Cumulation.Value<?> cumulationValue)
	{
		super(phase);
		this.index = index;
	...
	{
		sendMessage(new RouterCumulationValueMessage(index, cumulationValue));
	}
