...
public class DeferredMessageQueueDialogClient extends DeferredMessageQueueDialog
{
	private final UUID recipientUuid;
	private final int distance;

	public DeferredMessageQueueDialogClient(Phase phase, UUID recipientUuid, int distance)
	{
		super(phase);
	...
	{
		sendMessage(new DeferredMessageQueueMessage(recipientUuid, distance));
	}
