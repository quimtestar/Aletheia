...
public class RouteableMessageDialogServer extends RouteableMessageDialog
{

	public RouteableMessageDialogServer(Phase phase)
	{
		super(phase);
	}
	...
	{
		RouteableMessage routeableMessage = recvMessage(RouteableMessage.class);
		RouteableSubMessageProcessor processor = getPeerToPeerNode().getRouteableSubMessageProcessor();
		for (RouteableSubMessage subMessage : routeableMessage.getRouteableSubMessages())
