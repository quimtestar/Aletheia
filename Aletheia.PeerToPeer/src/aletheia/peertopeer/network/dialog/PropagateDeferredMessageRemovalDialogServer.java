...
public class PropagateDeferredMessageRemovalDialogServer extends PropagateDeferredMessageRemovalDialog
{

	public PropagateDeferredMessageRemovalDialogServer(Phase phase)
	{
		super(phase);
	}
	...
	{
		final DeferredMessageRemovalMessage deferredMessageRemovalMessage = recvMessage(DeferredMessageRemovalMessage.class);
		AsynchronousInvoker.instance.invoke(new AsynchronousInvoker.Invokable()
		{
			...
			public void invoke()
			{
				...
				if (deferredMessageSet != null)
					deferredMessageSet.removeDeferredMessages(deferredMessageRemovalMessage.getRecipientUuid(),
							deferredMessageRemovalMessage.getDeferredMessageUuids());
			}
		});
	}
