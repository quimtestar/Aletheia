...
public class InitialNetworkPhaseTypeDialogFemale extends InitialNetworkPhaseTypeDialog
{

	public InitialNetworkPhaseTypeDialogFemale(Phase phase)
	{
		super(phase);
	}
	...
	{
		InitialNetworkPhaseTypeMessage m = recvMessage(InitialNetworkPhaseTypeMessage.class);
		setType(m.getType());
	}
