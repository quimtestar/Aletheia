...
public class InitialNetworkPhaseTypeDialogMale extends InitialNetworkPhaseTypeDialog
{

	public InitialNetworkPhaseTypeDialogMale(Phase phase, InitialNetworkPhaseType type)
	{
		super(phase);
		setType(type);
	}
	...
	{
		sendMessage(new InitialNetworkPhaseTypeMessage(getType()));
	}
