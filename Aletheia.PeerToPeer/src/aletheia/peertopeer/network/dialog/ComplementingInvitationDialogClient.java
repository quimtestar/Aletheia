...
public class ComplementingInvitationDialogClient extends ComplementingInvitationDialog
{
	private final NodeAddress nodeAddress;

	public ComplementingInvitationDialogClient(Phase phase, NodeAddress nodeAddress)
	{
		super(phase);
	...
	{
		sendMessage(new ComplementingInvitationMessage(nodeAddress));
	}
