...
public class PropagateDeferredMessageRemovalDialogClient extends PropagateDeferredMessageRemovalDialog
{
	private final UUID recipientUuid;
	private final Collection<UUID> deferredMessageUuids;

	public PropagateDeferredMessageRemovalDialogClient(Phase phase, UUID recipientUuid, Collection<UUID> deferredMessageUuids)
	{
		super(phase);
	...
	{
		sendMessage(new DeferredMessageRemovalMessage(recipientUuid, deferredMessageUuids));
	}
