...
public class ClosestNodeDialogFemale extends ClosestNodeDialog
{

	public ClosestNodeDialogFemale(Phase phase)
	{
		super(phase);
	}
	...
	{
		NodeAddress address = getPeerToPeerNode().closestNodeAddress(getNetworkPhase().getPeerNodeUuid());
		sendMessage(new RedirectAddressMessage(address));
		setRedirectNodeAddress(address);
	}
