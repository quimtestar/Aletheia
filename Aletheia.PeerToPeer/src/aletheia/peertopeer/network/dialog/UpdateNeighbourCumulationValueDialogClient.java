...
public class UpdateNeighbourCumulationValueDialogClient extends UpdateNeighbourCumulationValueDialog
{
	private final Cumulation.Value<?> cumulationValue;

	public UpdateNeighbourCumulationValueDialogClient(Phase phase, Cumulation.Value<?> cumulationValue)
	{
		super(phase);
	...
	{
		sendMessage(new NeighbourCumulationValueMessage(cumulationValue));
	}
