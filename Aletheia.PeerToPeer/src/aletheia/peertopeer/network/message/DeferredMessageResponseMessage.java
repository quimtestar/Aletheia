...
import aletheia.model.peertopeer.protocol.DeferredMessageProtocol;
...
public class DeferredMessageResponseMessage extends AbstractUUIDPersistentInfoMessage<DeferredMessage>
{
	...
	{
		return new DeferredMessageResponseMessage(new BijectionCollection<>(new Bijection<DeferredMessage, Entry>()
		{
