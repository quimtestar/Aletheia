...
public class DelegateTreeDelegateDependencyResponseMessage extends DelegateTreeDependencyResponseMessage<Person>
{
	...
	public DelegateTreeDelegateDependencyResponseMessage(Collection<? extends AbstractUUIDPersistentInfoMessage.Entry<Person>> entries)
	{
		super(entries);
	}

	@ProtocolInfo(availableVersions = 0)
	public static class SubProtocol extends DelegateTreeDependencyResponseMessage.SubProtocol<Person, DelegateTreeDelegateDependencyResponseMessage>
	{
		...
		@Override
		public DelegateTreeDelegateDependencyResponseMessage recv(DataInput in) throws IOException, ProtocolException
		{
			List<AbstractUUIDPersistentInfoMessage.Entry<Person>> entries = recvEntries(in);
			return new DelegateTreeDelegateDependencyResponseMessage(entries);
		}
