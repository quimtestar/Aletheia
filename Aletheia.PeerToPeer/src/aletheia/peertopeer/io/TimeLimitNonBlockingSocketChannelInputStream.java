...
import aletheia.utilities.io.NonBlockingSocketChannelInputStream;

public class TimeLimitNonBlockingSocketChannelInputStream extends NonBlockingSocketChannelInputStream
{
	private final long extraTime;

	private long timeLimit;

	public TimeLimitNonBlockingSocketChannelInputStream(SocketChannel socketChannel, long extraTime) throws IOException
	{
		super(socketChannel);
		this.extraTime = extraTime;
	}

	public TimeLimitNonBlockingSocketChannelInputStream(SocketChannel socketChannel) throws IOException
	{
