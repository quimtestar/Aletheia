...
public class EphemeralMaleRootPhase extends MaleRootPhase
{

	public EphemeralMaleRootPhase(MalePeerToPeerConnection peerToPeerConnection)
	{
		super(peerToPeerConnection, SubRootPhaseType.Ephemeral);
	}

	@Override
	public synchronized EphemeralPhase waitForSubRootPhase() throws InterruptedException
	{
		return (EphemeralPhase) super.waitForSubRootPhase();
	}

	@Override
	public synchronized EphemeralPhase waitForSubRootPhase(ListenableAborter aborter) throws InterruptedException, AbortException
	{
