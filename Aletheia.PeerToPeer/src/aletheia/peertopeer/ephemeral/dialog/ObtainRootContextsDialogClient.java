...
public class ObtainRootContextsDialogClient extends ObtainRootContextsDialog
{
	private final Collection<UUID> signatureUuids;
	private final Map<UUID, RootContext> rootContexts;

	public ObtainRootContextsDialogClient(Phase phase, Collection<UUID> signatureUuids)
	{
		super(phase);
