...
public class PersonsDialogServer extends PersonsDialog
{

	public PersonsDialogServer(Phase phase)
	{
		super(phase);
	}
	...
	{
		PersonInfoMessage personsInfoMessage = dialogatePersonInfoRecv();
		if (!personsInfoMessage.getEntries().isEmpty())
		{
			dialogatePersonRequestSend(personsInfoMessage);
