...
public class ConnectionIdDialogMale extends ConnectionIdDialog
{
	private final int connectionId;

	public ConnectionIdDialogMale(Phase phase, int connectionId)
	{
		super(phase);
	...
	{
		sendMessage(new ConnectionIdMessage(connectionId));
	}
